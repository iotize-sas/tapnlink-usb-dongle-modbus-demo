...
export class MemoryComponent implements OnInit, OnDestroy {
   ...
   */
  variables: Partial<{
    freeMemoryMB: TapVariable<number, "freeMemoryMB">;

    totalMemoryMB: TapVariable<number, "totalMemoryMB">;

    freeMemoryPercentage: TapVariable<number, "freeMemoryPercentage">;
  }> = {};
  ...
  private initVariableCache() {
    ...
    try {
      this.variables.freeMemoryMB = this.dataManager.variable(
        "freeMemoryMB"
      ) as any;

      this.variables.totalMemoryMB = this.dataManager.variable(
        "totalMemoryMB"
      ) as any;

      this.variables.freeMemoryPercentage = this.dataManager.variable(
